...
response = s.get(url, headers=headers, cookies=cookies, params=params,proxies=None)
print(response.text)
...
print(x_s3_tid)
print(x_s3_sid)
x_s3_s4e = execjs.compile(open('get_x_s3_s4e.js', 'r', encoding='utf-8').read()).call('get_x_s3_s4e', x_s3_tid, x_s3_sid)
print(x_s3_s4e)
headers = {
...
#     "sccode": "%7BsccodeInfo%3A%22%u822A%u73ED%u5217%u8868%u9875%26%u4EF7%u683C%u65E5%u5386%22%7D",
#     "ariauseGraymode": "false",
#     "sw_rtk":"Wgx20hsqh4kazQ8k8cLBe34ac91f"
# }
cookies = {
    'JSESSIONID': '425AF37FA60D0045318C144596297BAE',
    'sajssdk_2015_cross_new_user': '1',
...
response = s.post(url, headers=headers, cookies=cookies, data=data, proxies=None)
